...
class LocalRepositoryTest {
    ...
    fun saveItem_savedAndFoundItem() = runTest {
        ...
        defaultRepository.saveAnalysis(actualItem).getOrThrow()
        val expectedItem = defaultRepository.findAnalysis(1).getOrThrow()

        assertEquals(1, expectedItem.id) //id is autogenerated
