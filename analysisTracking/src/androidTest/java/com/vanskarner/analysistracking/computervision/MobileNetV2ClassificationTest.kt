...
class MobileNetV2ClassificationTest {
    ...
    fun predictionUsingAutogeneratedModelWithBacterialSpot() = runTest {
        ...
        val predictionResult = useMobilenetV2WithAutogeneratedModel(appContext, image, modelOptions)
    ...
    fun predictionUsingAutogeneratedModelWithImageList() = runTest {
        ...
        val classificationByBatch =
            useMobilenetV2WithAutogeneratedModel(appContext, imgList, modelOptions).getOrThrow()
